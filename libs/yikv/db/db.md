...
```bash
bazel run //libs/yikv/db:db_tool -- fill --db /data/yikv --index kv_all --target-gb 5.2 --recreate \
...
bazel run //libs/yikv/db:db_tool -- bench-write --db /data/yikv --index kv_all --ops 5000
